...
A minimal example for a [_drat_ repository](https://github.com/ropenscilabs/tic.drat.demo) created and uploaded by _tic_, hosting source and binary macOS packages.
